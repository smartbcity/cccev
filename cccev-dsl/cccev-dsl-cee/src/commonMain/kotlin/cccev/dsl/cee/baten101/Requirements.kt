...
import cccev.dsl.cee.DateDevis
...
object BesoinPareVapeur: InformationRequirement(
    ...
    identifier = "resistanceThermiqueMinimale",
    name = """
        Un pare-vapeur ou tout autre dispositif permettant d'atteindre un résultat équivalent est mise en place, lorsqu'il est nécessaire 
